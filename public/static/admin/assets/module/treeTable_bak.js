layui.define(["laytpl", "form", "util"], function (exports) {
    var jquery = layui.jquery,
        ...
        d = {
            ...
            tree: {
                ...
                getIcon: function (e) {
                    ...
                    return undefined !== t ? t = true === t || "true" === t : e[this.childName] && (t = e[this.childName].length > 0), t ? '<i class="ew-tree-icon layui-icon layui-icon-layer"></i>' : '<i class="ew-tree-icon layui-icon layui-icon-file"></i>'
                }
            }
        },
        s = {
        ...
        c = function (e) {
            n[e.elem.substring(1)] = this;
            this.reload(e);
        };

    function h(e) {
        var i,
            a = parseInt(e.data("indent")),
            o = e.hasClass("ew-tree-table-open");

        o ? (e.removeClass("ew-tree-table-open"), e.nextAll("tr").each((function () {
            if (parseInt(jquery(this).data("indent")) <= a) return false;
            jquery(this).addClass("ew-tree-tb-hide")
        }))) : (e.addClass("ew-tree-table-open"), e.nextAll("tr").each((function () {
            var e = parseInt(jquery(this).data("indent"));
            return !(e <= a) && (undefined !== i && e > i || (jquery(this).removeClass("ew-tree-tb-hide"), void (i = jquery(this).hasClass("ew-tree-table-open") ? undefined : parseInt(jquery(this).data("indent")))))
        })));
    ...
    function b() {
        jquery(".ew-tree-table-cell").removeClass("ew-tree-tips-open ew-show-left ew-show-bottom"), jquery(".ew-tree-table-cell>.ew-tree-table-cell-content").css({
            width: "",
            "max-width": ""
        })
    }
    ...
    function w(e, t) {
        if ("Array" === f(t)) for (var i = 0; i < t.length; i++) if (e == t[i]) return true;
        return e == t
    }
    ...
    c.prototype.initOptions = function (e) {
        ...
        function a(e) {
            return e.INIT_OK || (e = jquery.extend({INIT_OK: true}, s, e)), "space" === e.type ? (e.width || (e.width = 15), e.minWidth = e.width) : "numbers" === e.type ? (e.width || (e.width = 40), e.minWidth = e.width, e.singleLine || (e.singleLine = false), e.unresize || (e.unresize = true), e.align || (e.align = "center")) : "checkbox" !== e.type && "radio" !== e.type || (e.width || (e.width = 48), e.minWidth = e.width, e.singleLine || (e.singleLine = false), e.unresize || (e.unresize = true), e.align || (e.align = "center")), e.toolbar && (e.type = "tool"), e
        }

        "Array" !== f(e.cols[0]) && (e.cols = [e.cols]);
        for (var o = 0; o < e.cols.length; o++) for (var r = 0; r < e.cols[o].length; r++) e.cols[o][r].INIT_OK = undefined, e.cols[o][r].key = undefined, e.cols[o][r].colGroup = undefined, e.cols[o][r].HAS_PARENT = undefined, e.cols[o][r].parentKey = undefined, e.cols[o][r].PARENT_COL_INDEX = undefined;
        for (var l = [], n = 0, c = 0; c < e.cols.length; c++) for (var h = e.cols[c], p = 0; p < h.length; p++) {
            ...
            if (b) {
                ...
                if (b.colGroup || b.colspan > 1) {
                    b.colGroup = true, b.type = "group", u = [], n++;
                    for (var w = 0, y = 0; y < e.cols[c + 1].length; y++) {
                        var A = jquery.extend({INIT_OK: true}, s, e.cols[c + 1][y]);
                        A.HAS_PARENT || w > 1 && w == b.colspan ? e.cols[c + 1][y] = A : (A.HAS_PARENT = true, A.parentKey = c + "-" + p, A.key = c + 1 + "-" + y, A.PARENT_COL_INDEX = n, A = a(A), u.push(A), w += parseInt(A.colspan > 1 ? A.colspan : 1), e.cols[c + 1][y] = A)
                    }
                }
                b.CHILD_COLS = u, b.PARENT_COL_INDEX || l.push(b), e.cols[c][p] = b
            } else h.splice(p, 1)
        }
        if (this.options = jquery.extend(true, {}, d, e), this.options.colArrays = l, this.options.url ? this.options.reqData = function (e, a) {
            i.options.where || (i.options.where = {}), e && (i.options.where[i.options.request.pidName] = e[i.options.tree.idName]), (i.options.useAdmin ? layui.admin : jquery).ajax({
                url: i.options.url,
            ...
            this.options.tree.getIcon = function (e) {
                ...
                var t = e[this.haveChildName];
                return undefined !== t ? t = true === t || "true" === t : e[this.childName] && (t = e[this.childName].length > 0), t ? '<i class="ew-tree-icon ew-tree-icon-folder"></i>' : '<i class="ew-tree-icon ew-tree-icon-file"></i>'
            }
        }
    }, c.prototype.init = function () {
        var e = this.options, o = jquery(e.elem), r = e.elem.substring(1);
        ...
        if (e.skin && l.$table.attr("lay-skin", e.skin), e.size && l.$table.attr("lay-size", e.size), e.even && l.$table.attr("lay-even", e.even), l.$toolbar.empty(), false === e.toolbar || undefined === e.toolbar) l.$toolbar.hide(); else {
            l.$toolbar.show(), "string" == typeof e.toolbar && laytpl(jquery(e.toolbar).html()).render({}, (function (e) {
                l.$toolbar.html(e)
            }));
        ...
        var c = this.resize(true), h = "<thead>" + this.renderBodyTh() + "</thead>";
        ...
        form.render("checkbox", r), l.$table.children("thead").children("tr").children("th.layui-hide").each((function () {
            !function e(t) {
                var i = t.data("parent");
                if (i) {
        ...
        })), e.reqData ? (this.options.data = undefined, this.renderBodyAsync()) : e.data && e.data.length > 0 ? this.renderBodyData(e.data) : (l.$loading.hide(), l.$empty.show())
        ...
        var e = this, i = this.options, o = this.getComponents(), r = o.$table.children("tbody"),
            n = function (r) {
                ...
                var d = e.getDataByTr(l), s = {
                    tr: l, data: d, del: function () {
                        ...
                        l.nextAll("tr").each((function () {
                            if (parseInt(jquery(this).data("indent")) <= r) return false;
                            jquery(this).remove()
                        }));
                        var n = "number" == typeof a ? 1 : a.split("-").length;
                        l.nextAll("tr").each((function () {
                            var e = jquery(this);
                            if (parseInt(e.data("indent")) < r) return false;
                            var i = e.data("index").toString().split("-");
                            i[n - 1] = parseInt(i[n - 1]) - 1, e.data("index", i.join("-"))
                        }));
                        var d = l.prevAll("tr");
                        e.del(undefined, a), l.remove(), e.renderNumberCol(), d.each((function () {
                            var i = parseInt(jquery(this).data("indent"));
                            if (i >= r) return true;
                            e.checkParentCB(jquery(this)), r = i
                        })), e.checkChooseAllCB(), 0 === i.data.length && o.$empty.show(), p(o.$view)
                    }, update: function (i) {
                        d = jquery.extend(true, d, i);
                        var r = parseInt(l.data("indent"));
                        e.renderBodyTr(d, r, undefined, l), form.render(null, o.filter), e.renderNumberCol(), l.prevAll("tr").each((function () {
                            var i = parseInt(jquery(this).data("indent"));
                            if (i >= r) return true;
                            e.checkParentCB(jquery(this)), r = i
                        })), e.checkChooseAllCB()
                ...
                return jquery.extend(s, r)
            };
        r.off("click.fold").on("click.fold", ".ew-tree-pack", (function (a) {
            layui.stope(a);
            var o = jquery(this).parentsUntil("tr").last().parent();
        ...
        })), form.on("radio(" + o.radioFilter + ")", (function (i) {
            var a = e.getDataByTr(jquery(i.elem).parentsUntil("tr").last().parent());
            e.removeAllChecked(), a.LAY_CHECKED = true, a.LAY_INDETERMINATE = false, layui.event.call(this, l, "checkbox(" + o.filter + ")", {
                checked: true,
                data: a,
                type: "one"
            })
        })), form.on("checkbox(" + o.checkboxFilter + ")", (function (a) {
            var r = a.elem.checked, n = jquery(a.elem), d = n.next(".layui-form-checkbox");
            !r && n.hasClass("ew-form-indeterminate") && (r = true, n.prop("checked", r), d.addClass("layui-form-checked"), n.removeClass("ew-form-indeterminate"));
            var s = n.parentsUntil("tr").last().parent(), c = e.getDataByTr(s);
            c.LAY_CHECKED = r, c.LAY_INDETERMINATE = false, c[i.tree.childName] && c[i.tree.childName].length > 0 && e.checkSubCB(s, r);
            var h = parseInt(s.data("indent"));
            s.prevAll("tr").each((function () {
                var i = parseInt(jquery(this).data("indent"));
                i < h && (e.checkParentCB(jquery(this)), h = i)
            })), e.checkChooseAllCB(), layui.event.call(this, l, "checkbox(" + o.filter + ")", {
                checked: r,
                data: c,
                type: "more"
            })
        })), form.on("checkbox(" + o.chooseAllFilter + ")", (function (a) {
            var r = a.elem.checked, n = jquery(a.elem), d = n.next(".layui-form-checkbox");
            if (!i.data || 0 === i.data.length) return n.prop("checked", false), d.removeClass("layui-form-checked"), void n.removeClass("ew-form-indeterminate");
            !r && n.hasClass("ew-form-indeterminate") && (r = true, n.prop("checked", r), d.addClass("layui-form-checked"), n.removeClass("ew-form-indeterminate")), layui.event.call(this, l, "checkbox(" + o.filter + ")", {
                checked: r,
                type: "all"
            ...
            var d = jquery(this), s = d.data("type");
            ...
            if (c) {
                ...
                if ("text" === c || "number" === c) {
                    var w = jquery('<input type="' + c + '" class="layui-input ew-tree-table-edit"/>');
                    w[0].value = u[h], d.append(w), w.focus(), w.blur((function () {
                        var a = jquery(this).val();
                        if (a == u[h]) return jquery(this).remove();
                        if (false === layui.event.call(this, l, "edit(" + o.filter + ")", n.call(this, {
                            value: a,
                            field: h
                        }))) jquery(this).addClass("layui-form-danger"), jquery(this).focus(); else {
                            u[h] = a;
            ...
            var i = jquery(this).data("type");
            "csv" !== i && "xls" !== i || e.exportData(i)
        })), o.$toolbar.off("click.panel").on("click.panel", ".layui-table-tool-panel", (function (e) {
            layui.stope(e)
        })), form.on("checkbox(" + o.colsToggleFilter + ")", (function (t) {
            e.toggleCol(t.elem.checked, undefined, t.value)
        }))
    }, c.prototype.getComponents = function () {
        var e = jquery(this.options.elem).next(".ew-tree-table"), i = e.attr("lay-filter"),
        ...
        undefined === i ? d.data = e : i[d.tree.childName] = e, o && (l = parseInt(o.data("indent")) + 1, i[d.tree.openName] = true);
        var c = this.renderBody(e, l, i);
        if (o ? (o.nextAll("tr").each((function () {
            if (parseInt(jquery(this).data("indent")) <= l - 1) return false;
            jquery(this).remove()
        })), o.after(c).addClass("ew-tree-table-open")) : s.$tBody.children("tbody").html(c), form.render(null, s.filter), this.renderNumberCol(), o) {
            this.checkParentCB(o), o.prevAll("tr").each((function () {
                var e = parseInt(jquery(this).data("indent"));
                e < l - 1 && (n.checkParentCB(jquery(this)), l = e + 1)
            })), o.removeClass("ew-tree-table-loading");
            var h = o.find(".ew-tree-pack").children(".ew-tree-table-arrow");
            h.removeClass("layui-anim layui-anim-rotate layui-anim-loop"), r ? o.removeClass("ew-tree-table-open") : e && 0 === e.length && (i[d.tree.haveChildName] = false, o.data("have-child", false), h.addClass("ew-tree-table-arrow-hide"), h.next(".ew-tree-icon").after(d.tree.getIcon(i)).remove())
        ...
        for (var r = i ? !i[a.tree.openName] : undefined, l = 0; l < e.length; l++) {
            var n = e[l];
        ...
        undefined === l && (l = e[r.tree.childName] && e[r.tree.childName].length > 0), a && (a.data("have-child", l ? "true" : "false"), a.data("indent", t), a.removeClass("ew-tree-table-loading"));
        var n = "<tr", d = "";
        ...
        return this.eachCols((function (i, r) {
            r.colGroup || (n += o.renderBodyTd(e, t, s, a ? a.children("td").eq(s) : undefined, r), s++)
        })), n += "</tr>"
        ...
        a || (a = 0);
        var c, h = "", p = "";
        if ("numbers" === n.type ? h = '<span class="ew-tree-table-numbers"></span>' : "checkbox" === n.type ? h = ['<input type="checkbox"', e.LAY_CHECKED ? ' checked="checked"' : "", ' lay-filter="', s.checkboxFilter, '"', ' lay-skin="primary" class="ew-tree-table-checkbox', e.LAY_INDETERMINATE ? " ew-form-indeterminate" : "", '" />'].join("") : "radio" === n.type ? h = ['<input type="radio"', e.LAY_CHECKED ? ' checked="checked"' : "", ' lay-filter="', s.radioFilter, '"', ' name="', s.radioFilter, '"', ' class="ew-tree-table-radio" />'].join("") : n.templet ? "function" == typeof n.templet ? h = n.templet(e) : "string" == typeof n.templet && laytpl(jquery(n.templet).html()).render(e, (function (e) {
            h = e
        })) : n.toolbar ? "function" == typeof n.toolbar ? h = n.toolbar(e) : "string" == typeof n.toolbar && laytpl(jquery(n.toolbar).html()).render(e, (function (e) {
            h = e
        })) : n.field && undefined !== e[n.field] && null !== e[n.field] && (h = util.escape(e[n.field] || "")), r === d.tree.iconIndex) {
            for (var b = 0; b < a; b++) p += '<span class="ew-tree-table-indent"></span>';
            p += '<span class="ew-tree-pack">';
            var u = e[d.tree.haveChildName];
            undefined === u && (u = e[d.tree.childName] && e[d.tree.childName].length > 0), p += '<i class="ew-tree-table-arrow layui-icon' + (u ? "" : " ew-tree-table-arrow-hide"), p += " " + (d.tree.arrowType || "") + '"></i>', p += d.tree.getIcon(e), h = "<span>" + h + "</span>", h = d.tree.onlyIconControl ? p + "</span>" + h : p + h + "</span>"
        }
        c = ['<div class="ew-tree-table-cell', undefined === n.singleLine || n.singleLine ? " single-line" : "", '"', n.align ? ' align="' + n.align + '"' : "", ">", '   <div class="ew-tree-table-cell-content">', h, "</div>", '   <i class="layui-icon layui-icon-close ew-tree-tips-c"></i>', '   <div class="layui-table-grid-down" style="display: none;"><i class="layui-icon layui-icon-down"></i></div>', "</div>"].join(""), l && l.html(c);
        var w = "<td";
        ...
        return jquery.each(e.cols, (function (e, o) {
            a.push("<tr>"), jquery.each(o, (function (e, t) {
                a.push("<th"), t.colspan && a.push(' colspan="' + t.colspan + '"'), t.rowspan && a.push(' rowspan="' + t.rowspan + '"'), t.type && a.push(' data-type="' + t.type + '"'), t.key && a.push(' data-key="' + t.key + '"'), t.parentKey && a.push(' data-parent="' + t.parentKey + '"'), t.hide && a.push(' class="layui-hide"'), a.push(">"), a.push('<div class="ew-tree-table-cell' + (undefined === t.singleLine || t.singleLine ? " single-line" : "") + '"'), (t.thAlign || t.align) && a.push(' align="' + (t.thAlign || t.align) + '"'), a.push(">"), a.push('<div class="ew-tree-table-cell-content">');
        ...
        var t = this.options, i = this.getComponents(), a = 1, o = 1, r = true, l = 0;
        this.eachCols((function (e, i) {
            i.colGroup || i.hide || (i.width ? (o += i.width + 1, i.minWidth ? i.width < i.minWidth && (i.width = i.minWidth) : i.width < t.cellMinWidth && (i.width = t.cellMinWidth)) : r = false, i.width ? a += i.width + 1 : i.minWidth ? (a += i.minWidth + 1, l += i.minWidth) : (a += t.cellMinWidth + 1, l += t.cellMinWidth))
        ...
        var t, i;
        if ("string" != typeof e && "number" != typeof e ? e && (i = e.data("index")) : i = e, undefined !== i) {
        ...
        e.is("tbody") ? a = e.children("tr") : (l = parseInt(e.data("indent")), a = e.nextAll("tr")), a.each((function () {
            if (parseInt(jquery(this).data("indent")) <= l) return false;
            var e = jquery(this).children("td").find('input[lay-filter="' + r.checkboxFilter + '"]');
            ...
            var a = o.getDataByTr(jquery(this));
            a.LAY_CHECKED = i, a.LAY_INDETERMINATE = false
        }))
        ...
        o > 0 && 0 === r ? (l.prop("checked", true), l.removeClass("ew-form-indeterminate"), l.next(".layui-form-checkbox").addClass("layui-form-checked"), a.LAY_CHECKED = true, a.LAY_INDETERMINATE = false) : 0 === o && r > 0 ? (l.prop("checked", false), l.removeClass("ew-form-indeterminate"), l.next(".layui-form-checkbox").removeClass("layui-form-checked"), a.LAY_CHECKED = false, a.LAY_INDETERMINATE = false) : o > 0 && r > 0 && (l.prop("checked", true), l.data("indeterminate", "true"), l.addClass("ew-form-indeterminate"), l.next(".layui-form-checkbox").addClass("layui-form-checked"), a.LAY_CHECKED = true, a.LAY_INDETERMINATE = true)
        ...
        i > 0 && 0 === a ? (o.prop("checked", true), o.removeClass("ew-form-indeterminate"), o.next(".layui-form-checkbox").addClass("layui-form-checked")) : 0 === i && a > 0 || 0 === i && 0 === a ? (o.prop("checked", false), o.removeClass("ew-form-indeterminate"), o.next(".layui-form-checkbox").removeClass("layui-form-checked")) : i > 0 && a > 0 && (o.prop("checked", true), o.addClass("ew-form-indeterminate"), o.next(".layui-form-checkbox").addClass("layui-form-checked"))
    }, c.prototype.renderNumberCol = function () {
        this.getComponents().$tBody.children("tbody").children("tr").each((function (e) {
            jquery(this).children("td").find(".ew-tree-table-numbers").text(e + 1)
        }))
    }, c.prototype.getIndexById = function (e) {
        var t = this.options;
        return function i(a, o) {
            for (var r = 0; r < a.length; r++) {
                if (a[r][t.tree.idName] === e) return undefined !== o ? o + "-" + r : r;
                if (a[r][t.tree.childName]) {
                    var l = i(a[r][t.tree.childName], undefined !== o ? o + "-" + r : r);
                    if (l) return l
                }
            }
        }(t.data)
        ...
        if (a.hasClass("ew-tree-table-open") || a.children("td").find(".ew-tree-pack").trigger("click"), false !== i) {
            var o = parseInt(a.data("indent"));
            a.prevAll("tr").each((function () {
                var e = parseInt(jquery(this).data("indent"));
                e < o && (jquery(this).hasClass("ew-tree-table-open") || jquery(this).children("td").find(".ew-tree-pack").trigger("click"), o = e)
            }))
        }
        ...
        this.getComponents().$table.children("tbody").children("tr").each((function () {
            jquery(this).hasClass("ew-tree-table-open") || jquery(this).children("td").find(".ew-tree-pack").trigger("click")
        }))
        ...
        this.initOptions(this.options ? jquery.extend(true, this.options, e) : e), this.init(), this.bindEvents()
    }, c.prototype.checkStatus = function (e) {
        undefined === e && (e = true);
        var i = [];
        return this.eachData((function (a, o) {
            !e && o.LAY_INDETERMINATE || !o.LAY_CHECKED || i.push(jquery.extend({isIndeterminate: o.LAY_INDETERMINATE}, o))
        })), i
    }, c.prototype.setChecked = function (e) {
        var i = this, a = this.getComponents(), o = a.$table.find('input[lay-filter="' + a.radioFilter + '"]');
        o.length > 0 ? o.each((function () {
            var a = i.getDataByTr(jquery(this).parentsUntil("tr").parent());
            if (a && e[e.length - 1] == a[i.options.tree.idName]) return jquery(this).next(".layui-form-radio").trigger("click"), false
        })) : a.$table.find('input[lay-filter="' + a.checkboxFilter + '"]').each((function () {
            for (var a = jquery(this), o = a.next(".layui-form-checkbox"), r = a.prop("checked"), l = a.hasClass("ew-form-indeterminate"), n = i.getDataByTr(a.parentsUntil("tr").parent()), d = 0; d < e.length; d++) if (n && e[d] == n[i.options.tree.idName]) {
        ...
        if ("show" === e) i.$toolbar.find(".layui-table-tool-panel").remove(), i.$toolbar.find('[lay-event="LAYTABLE_EXPORT"]').append(['<ul class="layui-table-tool-panel">', '   <li data-type="csv">导出到 Csv 文件</li>', '   <li data-type="xls">导出到 Excel 文件</li>', "</ul>"].join("")); else {
            ...
            this.eachCols((function (e, t) {
                ...
                jquery(this).children("td").each((function () {
                    var i = jquery(this);
                    if ("normal" !== i.data("type") || i.hasClass("layui-hide")) return true;
        ...
        var a = e.$tBody.children("tbody").html(), o = e.$tBody.children("colgroup").html(),
            r = jquery(['<table class="ew-tree-table-print">', "   <colgroup>", o, "</colgroup>", "   <thead>", i, "</thead>", "   <tbody>", a, "</tbody>", "</table>"].join(""));
        ...
        if (undefined === e) {
            ...
            this.eachCols((function (e, t) {
                "normal" === t.type && (l.push('<li><input type="checkbox" lay-skin="primary"'), l.push(' lay-filter="' + r.colsToggleFilter + '"'), l.push(' value="' + t.key + '" title="' + util.escape(t.title || "") + '"'), l.push((t.hide ? "" : " checked") + "></li>"))
            })), r.$toolbar.find('[lay-event="LAYTABLE_COLS"]').append(l.join("") + "</ul>"), form.render("checkbox", r.filter)
        } else if (i) {
        ...
        if ("string" == typeof e) a.each((function () {
            ...
            jquery(this).children("td").each((function () {
                if (-1 !== jquery(this).text().indexOf(e)) return o.push(i), false
            }))
        ...
        for (var l = 0; l < o.length; l++) {
            ...
            n.nextAll("tr").each((function () {
                if (parseInt(jquery(this).data("indent")) <= d) return false;
                jquery(this).removeClass("ew-tree-table-filter-hide")
            })), n.hasClass("ew-tree-table-open") && h(n), n.prevAll("tr").each((function () {
                var e = parseInt(jquery(this).data("indent"));
                e < d && (jquery(this).removeClass("ew-tree-table-filter-hide"), jquery(this).hasClass("ew-tree-table-open") || h(jquery(this)), d = e)
            }))
        }
        a.not(".ew-tree-table-filter-hide").not(".ew-tree-tb-hide").each((function () {
            for (var e = jquery(this).data("index"), i = true, a = 0; a < o.length; a++) o[a] === e && (i = false);
            i && jquery(this).addClass("ew-tree-table-filter-hide")
        ...
        jquery.extend(true, this.getDataByTr(this.getIndexById(e)), i)
    }, jquery(window).resize((function () {
        jquery(".ew-tree-table").each((function () {
            p(jquery(this));
            var e = jquery(this).children(".ew-tree-table-box"), i = e.data("full");
            i && device.ie && device.ie < 10 && e.css("height", y() - i)
        }))
    })), jquery(document).on("mouseenter", ".ew-tree-table-cell.single-line", (function () {
        var e = jquery(this).children(".ew-tree-table-cell-content");
        e.prop("scrollWidth") > e.outerWidth() && jquery(this).children(".layui-table-grid-down").show()
    })).on("mouseleave", ".ew-tree-table-cell.single-line", (function () {
        jquery(this).children(".layui-table-grid-down").hide()
    })), jquery(document).on("click", ".ew-tree-table-cell>.layui-table-grid-down", (function (e) {
        e.stopPropagation(), b();
    ...
    })), jquery(document).on("click", ".ew-tree-table-cell>.ew-tree-tips-c", (function () {
        b()
    })), jquery(document).on("click", (function () {
        b(), jquery(".ew-tree-table .layui-table-tool-panel").remove()
    })), jquery(document).on("click", ".ew-tree-table-cell.ew-tree-tips-open", (function (e) {
        e.stopPropagation()
    })), jquery(document).on("mousedown", ".ew-tb-resize", (function (e) {
        layui.stope(e);
        var i = jquery(this);
        i.attr("move", "true");
        ...
        o && -1 === o.toString().indexOf("%") || (o = i.parent().outerWidth()), i.data("width", o), jquery("body").addClass("ew-tree-table-resizing")
    })).on("mousemove", (function (e) {
        var i = jquery('.ew-tree-table .ew-tb-resize[move="true"]');
        if (0 !== i.length) {
            layui.stope(e);
        ...
        jquery('.ew-tree-table .ew-tb-resize[move="true"]').attr("move", "false"), jquery("body").removeClass("ew-tree-table-resizing")
    ...
    var g = {
        render: function (e) {
            ...
            for (var r = [], l = 0; l < e.length; l++) {
                ...
                if (undefined === o && (o = u(e, t, i)), w(e[l][i], o)) {
